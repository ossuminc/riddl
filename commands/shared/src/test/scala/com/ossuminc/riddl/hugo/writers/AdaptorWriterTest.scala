...
class AdaptorWriterTest extends WriterTest {
  ...
  "AdaptorWriter" must {
    "handle a message rename" in {
      val url = URL.fromCwdPath("commands/shared/src/test/input/adaptors.riddl")
          ...
          case passesResult: PassesResult =>
            ...
            val expected =
              """---
                ...
                || _View Source Link_ | [commands/shared/src/test/input/adaptors.riddl(77->372)]() |
                || _Used By_ | None |
                || _Uses_ | None |
                |
                |## *Description*
                ...
                || _View Source Link_ | [commands/shared/src/test/input/adaptors.riddl(158->368)]() |
                || _Used By_ | None |
                || _Uses_ | None |
                |
                |## *Description*
