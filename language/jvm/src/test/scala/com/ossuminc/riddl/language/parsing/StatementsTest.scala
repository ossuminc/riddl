...
class StatementsTest extends ParsingTest{
  ...
  "Statements" must {
    ...
    "check Code Statement" in {
      ...
      s.format must be(s"```${language.s}$body```")
      checkStatement(s)
    }
