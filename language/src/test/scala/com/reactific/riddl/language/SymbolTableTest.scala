...
class SymbolTableTest extends ParsingTest {
  ...
  "Symbol table" should {
    ...
    "capture all expected symbol references and parents" in {
      ...
      assertRefWithParent[Pipe, Context](Seq("AChannel"), "APlant")
      assertRefWithParent[Processor, Context](Seq("Source"), "APlant")
      assertRefWithParent[Processor, Context](Seq("Sink"), "APlant")
