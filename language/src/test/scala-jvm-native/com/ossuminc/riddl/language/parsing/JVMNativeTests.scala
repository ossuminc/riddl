...
class JVMNativeRepositoryStatementsParsingTest extends RepositoryStatementsParsingTest
class JVMNativeCollectionPredicateParsingTest extends CollectionPredicateParsingTest
