...
INCLUDE_FRAGMENTS = {
    ...
    "more.riddl",                    # Context-level fragment included by include-transparency/dup-across-include/
    "inner.riddl",                   # Type fragment included (via outer.riddl) by include-transparency/nested-include/
}
