...
//////////////////////////////////////////////////////////// VALUE EXPRESSIONS
  ...
  /** Represents an operator that is merely a reference to some value, presumably an entity state value but could also
  ...
  /** Represents an operator that returns the Id(Entity) for the current stateful definition
    */
  case class IdOf(loc: At, path: PathIdentifier) extends Expression {
    override def format: String = "@self"
    def expressionType: TypeExpression = UniqueId(loc, path)
  }
