...
trait ParsingErrors {
  ...
  private val errors: mutable.ListBuffer[Messages.Message] = mutable.ListBuffer.empty[Messages.Message]

  protected def errorsNonEmpty: Boolean = synchronized { errors.nonEmpty }
  ...
  protected def errorsAsList: List[Messages.Message] = {
    synchronized {
      errors.toList
    }
  }
