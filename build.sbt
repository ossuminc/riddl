...
lazy val utils = utils_cp.jvm
  .configure(With.typical, With.build_info, With.coverage(70), With.publishing)
  .settings(
...
lazy val utils_jvm = utils_cp.jvm.configure(With.typical, With.build_info, With.js(hasMain=false))
