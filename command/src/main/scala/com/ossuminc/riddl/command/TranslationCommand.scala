...
import com.ossuminc.riddl.utils.{PlatformIOContext, OutputFile, Timer}
...
/** An abstract base class for translation style commands. That is, they translate an input file into an output
  ...
  */
abstract class TranslationCommand[OPT <: TranslationCommand.Options: ClassTag](name: String)(using io: PlatformIOContext)
