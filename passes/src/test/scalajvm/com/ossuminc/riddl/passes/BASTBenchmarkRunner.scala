...
object BASTBenchmarkRunner {
  ...
  val testFiles: Seq[TestFile] = Seq(
    TestFile(
      "small",
      "testkit/src/test/resources/performance/small.riddl",
      "~60 lines, 2 contexts"
    ),
    TestFile(
      "medium",
      "testkit/src/test/resources/performance/medium.riddl",
      "~370 lines, 7 contexts"
    ),
    TestFile(
      "large",
      "testkit/src/test/resources/performance/large.riddl",
