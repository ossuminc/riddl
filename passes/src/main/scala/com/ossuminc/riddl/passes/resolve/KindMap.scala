...
/** Mapping from implementation class to the instances of definitions. This keeps track of the
  * instances of each kind of [[com.ossuminc.riddl.language.AST.RiddlValue]] in a model. It is
  * generated by the [[ResolutionPass]].
  */
case class KindMap() {
